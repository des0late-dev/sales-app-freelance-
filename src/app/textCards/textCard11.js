  ...
  return (
    <div className="relative w-full max-w-[1152px] mx-auto bg-white text-black rounded-lg shadow-lg overflow-hidden font-source px-6 sm:px-8 py-20">
      <div className="space-y-[44px] text-lg text-[#1E1E1E] text-[32px] leading-[38px] p-8 md:p-10 pl-8 md:pl-10">
        <p>
          <strong><i>Here&apos;s <span className="ml-1"></span></i></strong>the secret: You don&apos;t need to <strong>win often</strong> to win big.
        </p>
        <p>
          Our service proves it:
        </p>
        <ul>
          <li> Only 7% of tips land - and that&apos;s enough to bank £8,201 profit. </li>
   ...
   <p><strong>{'“'}How the hell did you pick that?{'”'}</strong></p>
        ...
        <p>That&apos;s the power of this system.</p>
      </div>
    </div>
  );
}
