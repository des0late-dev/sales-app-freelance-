...
export default function TextCards() {
  return (
    <div className="relative w-full max-w-[1152px] mx-auto bg-white text-black rounded-lg shadow-lg overflow-hidden -mt-12 font-source  px-6 sm:px-8 py-10">

      <div className="space-y-8 text-lg text-[#1E1E1E]  text-[26px] leading-[32px] p-6 md:p-8 pl-8 md:pl-10">
        <p>
