...
export default function TextCard9() {
  return (
    <div className="relative sm:w-full w-[365px] max-w-[1152px] mx-auto bg-white text-black  shadow-lg overflow-hidden font-source    px-8 sm:px-10 py-9">
      <div className="sm:space-y-[44px] space-y-[23px] text-[17.97px] leading-[20px] text-[#1E1E1E]  sm:text-[32px] sm:leading-[38px]  sm:px-14  ">
